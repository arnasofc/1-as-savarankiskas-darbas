...
public:
    ...
    void output_sarasas1List();
    void output_sarasas2List();
    void output_sarasas3List();
    void output_sarasas4List();
    void output_sarasas5List();

    void output_sarasas1Deque();
    void output_sarasas2Deque();
    void output_sarasas3Deque();
    void output_sarasas4Deque();
    void output_sarasas5Deque();
    ...
    ClockTime end_time6;
    ClockTime start_time7;
    ClockTime end_time7;
    ClockTime start_time8;
    ClockTime end_time8;
...
void versijadu::vidurkisV() {
    ...
    averageVList.push_back(hold2);
    averageVDeque.push_back(hold2);
}
...
void versijadu::finalGradeV(double vidurkis, double egzaminas) {
    ...
    galutinisVList.push_back(vidurkisG);
    galutinisVDeque.push_back(vidurkisG);
}
...
void versijadu::vidurkisM() {
    ...
    averageMList.push_back(hold3);
    averageMDeque.push_back(hold3);
    namaiV.clear();
    namaiL.clear();
    namaiD.clear();
}
...
void versijadu::finalGradeM(double vidurkis, double egzaminas) {
    ...
    galutinisMList.push_back(vidurkisGM);
    galutinisMDeque.push_back(vidurkisGM);
}
...
void versijadu::input_mainDeque(int iki, string sarasas) {
    ...
    if (input.is_open()) {
        ...
        for (int p = 0; p < iki; p++)
        {
            ...
            vidurkisV();
            finalGradeV(averageVDeque[p], egzaminasD[p]);
            vidurkisM();
            finalGradeM(averageMDeque[p], egzaminasD[p]);
            namaiD.clear();
            getline(input, dummy);
        }
        end_time6 = Clock::now();
...
void versijadu::output_sarasas1List() {
    input_main(1000, "sarasas1.txt");
    input_mainList(1000, "sarasas1.txt");
    input_output(1000, sarasas1_vargsiukai, sarasas1_kietiakiai);
}

void versijadu::output_sarasas1Deque() {
...
void versijadu::output_sarasas2List() {
    input_mainList(10000, "sarasas2.txt");
    input_output(10000, sarasas2_vargsiukai, sarasas2_kietiakiai);
}

void versijadu::output_sarasas2Deque() {
...
void versijadu::output_sarasas3List() {
    input_mainList(100000, "sarasas3.txt");
    input_output(100000, sarasas3_vargsiukai, sarasas3_kietiakiai);
}

void versijadu::output_sarasas3Deque() {
...
void versijadu::output_sarasas4List() {
    input_mainList(1000000, "sarasas4.txt");
    input_output(1000000, sarasas4_vargsiukai, sarasas4_kietiakiai);
}

void versijadu::output_sarasas4Deque() {
...
void versijadu::output_sarasas5List() {
    input_mainList(10000000, "sarasas5.txt");
    input_output(10000000, sarasas5_vargsiukai, sarasas5_kietiakiai);
}

void versijadu::output_sarasas5Deque() {
    input_mainDeque(10000000, "sarasas5.txt");
    input_output(10000000, sarasas5_vargsiukai, sarasas5_kietiakiai);
}
...
void versijadu::output_rusiavimas() {
    cout << "Kuri konteineri norite naudoti testavimui? (a: Vector b: List c: Deque d: Visus) ";
    cin >> answw;
    cout << endl;
    ...
    if (answw == "a") {
        ...
        start_time8 = Clock::now();

        cout << "Sarasas 1 - Vargsiukai and Kietiakiai is progress..." << endl;
        output_sarasas1Deque();
        cout << "Sarasas 1 splicing is completed." << endl;
        cout << endl;

        cout << "Sarasas 2 - Vargsiukai and Kietiakiai is progress..." << endl;
        output_sarasas2Deque();
        cout << "Sarasas 2 splicing is completed." << endl;
        cout << endl;

        cout << "Sarasas 3 - Vargsiukai and Kietiakiai is progress..." << endl;
        // output_sarasas3Deque();
        cout << "Sarasas 3 splicing is completed." << endl;
        cout << endl;

        cout << "Sarasas 4 - Vargsiukai and Kietiakiai is progress..." << endl;
        // output_sarasas4Deque();
        cout << "Sarasas 4 splicing is completed." << endl;
        cout << endl;

        cout << "Sarasas 5 - Vargsiukai and Kietiakiai is progress..." << endl;
        // output_sarasas5Deque();
        cout << "Sarasas 5 splicing is completed." << endl;
        cout << endl;
...
void versijadu::spartos_analize() {
    ...
    printExecutionTime(start_time7, end_time7, "Studentu rusiavimas i du naujus failus (List):     ");
    printExecutionTime(start_time8, end_time8, "Studentu rusiavimas i du naujus failus (Deque):    ");
